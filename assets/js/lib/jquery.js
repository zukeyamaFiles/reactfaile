...
(function (a, b) {
    ...
    function cc(a) {
        ...
        if (c === "none" || c === "") {
            bI = e
                .body
                .appendChild(bI || p.extend(e.createElement("iframe"), {
                    frameBorder: 0,
                    height     : 0,
                    width      : 0
                }));
            ...
            b = bJ
                .body
                .appendChild(bJ.createElement(a)),
            c = bH(b, "display"),
            e
                .body
                .removeChild(bI)
    ...
    function cY(a, b, c) {
        ...
        ], p.css(a, "display") === "inline" && p.css(a, "float") === "none" && (!p.support.inlineBlockNeedsLayout || cc(a.nodeName) === "inline"
            ...
            if (typeof a == "string") {
                ...
                if (f && (f[1] || !c)) {
                    if (f[1]) 
                        ...
                        v.test(f[1]) && p.isPlainObject(c) && this
                            .attr
                            .call(a, c, !0),
                        p.merge(this, a);
    ...
    p.extend({
        ...
        makeArray    : function (a, b) {
            var c,
                d = b || [];
            return a != null && (c = p.type(a), a.length == null || c === "string" || c === "function" || c === "regexp" || p.isWindow(a)
                ? j.call(d, a)
                : p.merge(d, a)),
            d
        },
    ...
    p.extend({
        ...
        when    : function (a) {
            var b = 0,
                c = k.call(arguments),
                d = c.length,
                e = d !== 1 || a && p.isFunction(a.promise)
                    ? d
                    : 0,
                f = e === 1
                    ? a
    ...
    return p(function () {
            ...
            d.innerHTML                                                                                                                                                                                                                                                                                                                                                                                                                                      = "",
            d.style.cssText                                                                                                                                                                                                                                                                                                                                                                                                                                  = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;p" +
    ...
    p
        ...
        .extend({
            ...
            val        : function (a) {
                ...
                if (!arguments.length) {
                    if (f) 
                        return c = p.valHooks[f.type] || p.valHooks[
                            f
                                .nodeName
                                .toLowerCase()
                        ],
                ...
                this.each(function (d) {
                    ...
                    c       = p.valHooks[this.type] || p.valHooks[
                        this
                            .nodeName
                            .toLowerCase()
                    ];
    ...
    p.extend({
        attr      : function (a, c, d, e) {
            ...
            if (typeof a.getAttribute == "undefined") 
                return p.prop(a, c, d);
            h = i !== 1 || !p.isXMLDoc(a),
            h && (c = c.toLowerCase(), g = p.attrHooks[c] || (T.test(c)
                ? M
                : L));
            if (d !== b) {
                if (d === null) {
        ...
        removeAttr: function (a, b) {
            ...
            if (b && a.nodeType === 1) {
                ...
                for (; g < d.length; g++) 
                    e = d[g],
                    e && (c = p.propFix[e] || e, f = T.test(e), f || p.attr(a, e, ""), a.removeAttribute(U
                        ? e
                        : c), f && c in a && (a[c] = !1))
                }
        },
                ...
                get: function (a) {
                    ...
                    for (; c < d; c++) {
                        ...
                        if (e.selected && (p.support.optDisabled
                            ? !e.disabled
                            : e.getAttribute("disabled") === null) && (!e.parentNode.disabled || !p.nodeName(e.parentNode, "optgroup"))) {
                            b = p(e).val();
                            if (i) 
                                return b;
                            g.push(b)
    ...
    p.event           = {
        ...
        keyHooks   : {
            filter: function (a, b) {
                return a.which == null && (a.which = b.charCode != null
                    ? b.charCode
                    : b.keyCode),
                a
            },
        ...
        mouseHooks : {
            filter: function (a, c) {
                ...
                !a.relatedTarget && i && (a.relatedTarget = i === a.target
                    ? c.toElement
                    : i),
                !a.which && h !== b && (a.which = h & 1
                    ? 1
                    : h & 2
                        ? 3
                        : h & 4
        ...
        trigger    : function (c, d, f, g) {
            if (!f || f.nodeType !== 3 && f.nodeType !== 8) {
                ...
                if (!f) {
                    h = p.cache;
                    for (j in h) 
                        h[j].events && h[j].events[s] && p
                            .event
                            .trigger(c, d, h[j].handle.elem, !0);
                    return
                }
                c.result = b,
                c.target || (c.target = f),
        ...
        setup       : function () {
            ...
            p
                ...
                .add(this, "click._submit keypress._submit", function (a) {
                    var c = a.target,
                        d = p.nodeName(c, "input") || p.nodeName(c, "button")
                            ? c.form
                            : b;
            ...
            p
                ...
                .add(this, "beforeactivate._change", function (a) {
                    ...
                    V.test(b.nodeName) && !p._data(b, "_change_attached") && (p.event.add(b, "change._change", function (a) {
                        this.parentNode && !a.isSimulated && !a.isTrigger && p
                            .event
    ...
    p.support.focusinBubbles || p.each({
        ...
        var c = 0,
            d = function (a) {
                p
                    .event
                    .simulate(b, a.target, p.event.fix(a), !0)
            };
        p.event.special[b] = {
            setup   : function () {
        ...
        .extend({
            ...
            off           : function (a, c, d) {
                ...
                if (a && a.preventDefault && a.handleObj) 
                    ...
                    p(a.delegateTarget).off(e.namespace
    ...
    p.each(("blur focus focusin focusout load resize scroll unload click dblclick mousedown " +
    ...
    function (a, b) {
        ...
        function bp(a, b, c, d, f) {
            ...
            if (!d && m.length === 1) {
                ...
                if (h.length > 2 && (j = h[0]).type === "ID" && b.nodeType === 9 && !f && e.relative[h[1].type]) {
                    b = e
                        .find
                        .ID(j.matches[0].replace(V, ""), b, f)[0];
                    if (!b) 
                        return c;
        ...
        var c,
            ...
            Z  = X(function (a) {
                ...
                a.firstChild && typeof a.firstChild.getAttribute !== n && a
                    .firstChild
                    .getAttribute("href") === "#"
            }),
            $  = X(function (a) {
            ...
            ba = X(function (a) {
                ...
                var b = r.getElementsByName && r
                    .getElementsByName(o)
                    .length === 2 + r
                    .getElementsByName(o + 0)
                    .length;
        ...
        e                  = bc.selectors = {
                ...
                ID   : d
                    ...
                    : function (a, c, d) {
                        if (typeof c.getElementById !== n && !d) {
                            ...
                            return e
                                ? e.id === a || typeof e.getAttributeNode !== n && e
                                    .getAttributeNode("id")
                                    .value === a
                                    ? [e]
                                    : b
                ...
                CHILD : function (a) {
                    ...
                    a[1] === "nth"
                        ? (a[2] || bc.error(a[0]), a[3] =+ (a[3]
                            ? a[4] + (a[5] || 1)
                            : 2 * (a[2] === "even" || a[2] === "odd")), a[4] =+ (a[6] + a[7] || a[2] === "odd"))
                        : a[2] && bc.error(a[0]),
                    a
                },
                PSEUDO: function (a) {
            ...
            pseudos     : {
                ...
                text    : function (a) {
                    ...
                    return a
                        .nodeName
                        .toLowerCase() === "input" && (b = a.type) === "text" && ((c = a.getAttribute("type")) == null || c.toLowerCase() === b)
                }
            },
            relative    : {
                " ": {
        ...
        r.querySelectorAll && function () {
            ...
            X(function (a) {
                ...
                a
                    ...
                    .length || e.push("\\[" + E + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"),
                a
        ...
        .extend({
            add    : function (a, b) {
                var c = typeof a == "string"
                        ? p(a, b)
                        : p.makeArray(a && a.nodeType
                            ? [a]
                            : a),
                    d = p.merge(this.get(), c);
                return this.pushStack(bh(c[0]) || bh(d[0])
                    ? d
                    : p.unique(d))
            },
            addBack: function (a) {
    ...
    var bl = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|foot" +
    ...
    p
        ...
        .extend({
                ...
                if (this[0]) {
                    ...
                    if (f) {
                        ...
                        for (h = e.cacheable || l - 1; i < l; i++) 
                            d.call(c && p.nodeName(this[i], "table")
                                ? bC(this[i], "tbody")
                                : this[i], i === h
                                ? g
                                : p.clone(g, !0, !0))
            ...
            replaceWith: function (a) {
                return bh(this[0])
                    ? this.length
                        ? this.pushStack(p(p.isFunction(a)
                            ? a()
                            : a), "replaceWith", a)
                        : this
                    : p.isFunction(a)
            ...
            text       : function (a) {
                return p.access(this, function (a) {
                    return a === b
                        ...
                        : this
                            .empty()
                            .append((this[0] && this[0].ownerDocument || e).createTextNode(a))
                }, null, a, arguments.length)
            },
            unwrap     : function () {
                return this
                    ...
                    if (!br.test(h)) 
                        ...
                        if (!p.support.tbody) {
                            ...
                            for (g = n.length - 1; g >= 0; --g) 
                                p.nodeName(n[g], "tbody") && !n[g].childNodes.length && n[g]
                                    .parentNode
                                    .removeChild(n[g])
                            }
    ...
    p.extend({
        css      : function (a, c, d, e) {
            ...
            d || e !== b
                ? (g = parseFloat(f), d || p.isNumeric(g)
                    ? g || 0
                    : f)
                : f
        },
    ...
    a.getComputedStyle
        ...
        : e.documentElement.currentStyle && (bH = function (a, b) {
            ...
            bQ.test(e) && !bM.test(b) && (c = f.left, d = a.runtimeStyle && a.runtimeStyle.left, d && (a.runtimeStyle.left = a.currentStyle.left), f.left = b === "fontSize"
                ? "1em"
                : e, e = f.pixelLeft + "px", f.left = c, d && (a.runtimeStyle.left = d)),
            e === ""
                ? "auto"
                : e
        }),
    p.each([
        ...
        p.cssHooks[b] = {
            ...
            set: function (a, c, d) {
                return b_(a, c, d
                    ? ca(a, b, d, p.support.boxSizing && p.css(a, "boxSizing") === "border-box")
                    : 0)
            }
        }
    }),
    p.support.opacity || (p.cssHooks.opacity = {
        get: function (a, b) {
            return bL.test((b && a.currentStyle
    ...
    p.fn.load = function (a, c, d) {
        ...
        p.ajax({
            ...
            .done(function (a) {
                g = arguments,
                h.html(e
                    ? p("<div>").append(a.replace(cr, "")).find(e)
                    : a)
            }),
        this
    },
    ...
    p.each([
        ...
        p[c] = function (a, d, e, f) {
            ...
            p.ajax({data: d, dataType: f, success: e, type: c, url: a})
        }
    }),
    p.extend({
        active       : 0,
        ajax         : function (a, c) {
            ...
            var d,
                ...
                l = p.ajaxSetup({}, c),
                m = l.context || l,
                n = m !== l && (m.nodeType || m instanceof p)
                    ? p(m)
                    : p.event,
                o = p.Deferred(),
            ...
            l.dataTypes  = p
                ...
                .toLowerCase()
                .split(s),
            l.crossDomain == null && (i = ct.exec(l.url.toLowerCase()) || !1, l.crossDomain = i && i.join(":") + (i[3]
                ? ""
                : i[1] === "http:"
                    ? 80
                    : 443) !== cj.join(":") + (cj[3]
            ...
            x.setRequestHeader("Accept", l.dataTypes[0] && l.accepts[l.dataTypes[0]]
            ...
            if (!l.beforeSend || l.beforeSend.call(m, x, l) !== !1 && v !== 2) {
                w = "abort";
                for (k in {complete: 1, error: 1, success: 1}) 
                    x[k](l[k]);
                g = cA(cw, l, c, x);
                if (!g) 
                    y(-1, "No Transport");
        ...
        _default: {
            get: function (a) {
                ...
                return a.elem[a.prop] == null || !!a.elem.style && a.elem.style[a.prop] != null
                    ? (b = p.css(a.elem, a.prop, !1, ""), !b || b === "auto"
                        ? 0
                        : b)
                    : a.elem[a.prop]
            },
    ...
    p.fx.timer    = function (a) {
        a() && p
            .timers
            .push(a) && !cO && (cO = setInterval(p.fx.tick, p.fx.interval))
    },
    p.fx.interval = 13,
    p.fx.stop     = function () {
        clearInterval(cO),
    ...
    p.fn.offset = function (a) {
        ...
        return (d = l.body) === k
            ...
            : (c = l.documentElement, p.contains(c, k)
                ? (typeof k.getBoundingClientRect != "undefined" && (j = k.getBoundingClientRect()), e = da(l), f = c.clientTop || d.clientTop || 0, g = c.clientLeft || d.clientLeft || 0, h = e.pageYOffset || c.scrollTop, i = e.pageXOffset || c.scrollLeft, {
                    left: j.left + i - g,
                    top : j.top + h - f
                })
                : j)
